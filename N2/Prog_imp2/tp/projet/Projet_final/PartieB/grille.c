...
void afficher_couleur(enum element_grille couleur) {
    switch (couleur){
        ...
        case PION:
            ...
            break;
        case TELEPORTATION:
            printf("%s", "\33[100m  ");  /* Affiche un carré noir pour le téléportation */
            break;
        default:
            printf("%s", "\33[00m  ");  /* Affiche un carré noir */
            break;               
...
void grille_tresor(Grille *G) {
    ...
    } while (G->element[ligne_tresor][colonne_tresor] == PION || G->element[ligne_tresor][colonne_tresor] == PIEGE || G->element[ligne_tresor][colonne_tresor] == MUR || G->element[ligne_tresor][colonne_tresor] == TRESOR|| G->element[ligne_tresor][colonne_tresor] == TELEPORTATION);
        ...
        for(j=0;j<colonne;j++){
            ...
            switch(tmp){
                ...
                case 'B':
                    ...
                    break;
                case 'T':
                    grille->element[i][j]=TELEPORTATION;
                    break;
                case ' ':
